...
const Signup = () => {
  ...
  const handleSignup = async (e) => {
    ...
    const userDetails = {
      name: username, // Change from "username" to "name"
      email,
      password,
      role,
        ...
        <form className="flex flex-col" onSubmit={handleSignup}>
          ...
          {role === 'student' && (
            <div className="flex space-x-4">
              <input className="border-2 border-blue-600 mb-4 text-lg text-white outline-none bg-transparent rounded-lg py-2 px-6 placeholder-gray-400 w-1/2"
